...
class RequestInputPane(sendRequestCallback: () => Unit, showBulkRequestCallback: () => Unit) extends GridPane {
  ...
  private val requestControlPane = new RequestControlPane(sendRequestCallback, showBulkRequestCallback)
